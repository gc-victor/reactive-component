...
export default () => (
    <Page>
        ...
        <section>
            <h2 className="text-lg font-cal mb-3">Define Component (using define)</h2>
            <div className="space-y-4">
                <define-counter className="p-4 border border-slate-300 rounded block">
                    <div className="space-y-4">
                        <p className="mb-2">
                        ...
                        <p className="text-sm text-gray-600 text-center">This component uses the functional define approach</p>
                    </div>
                </define-counter>
            </div>
        </section>
